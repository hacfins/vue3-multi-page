import { getCurrentInstance, ref, computed, watch, inject, defineComponent, openBlock, createBlock, createVNode, withDirectives, vModelCheckbox, renderSlot, Fragment, createTextVNode, toDisplayString, createCommentVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("label", {
    ...
    (_ctx.$slots.default || _ctx.label)
      ...
      : createCommentVNode("v-if", true)
  ], 10 /* CLASS, PROPS */, ["id", "aria-controls"]))
}
