...
var script$2 = defineComponent({
    ...
    setup(props, ctx) {
        ...
        const { inputWidth, selected, inputLength, filteredOptionsCount, visible, softFocus, selectedLabel, hoverIndex, query, inputHovering, currentPlaceholder, menuVisibleOnFocus, isOnComposition, isSilentBlur, options, cachedOptions, optionsCount, prefixWidth, tagInMultiLine, } = toRefs(states);
            ...
            (_ctx.emptyText && (!_ctx.allowCreate || _ctx.loading || (_ctx.allowCreate && _ctx.options.size === 0 )))
              ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                  (_ctx.$slots.empty)
                    ...
                    : (openBlock(), createBlock("p", _hoisted_5, toDisplayString(_ctx.emptyText), 1 /* TEXT */))
