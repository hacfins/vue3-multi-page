...
var script = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        return Object.assign(Object.assign({}, dialog.useDialog(props, ctx, drawerRef)), { drawerRef, isHorizontal: vue.computed(() => props.direction === 'rtl' || props.direction === 'ltr'), drawerSize: vue.computed(() => typeof props.size === 'number' ? `${props.size}px` : props.size) });
    },
});
