  ...
  return (vue.openBlock(), vue.createBlock("div", {
              ...
              ((_ctx.showText || _ctx.$slots.default) && _ctx.textInside)
                ? (vue.openBlock(), vue.createBlock("div", _hoisted_2, [
                    vue.renderSlot(_ctx.$slots, "default", _ctx.slotData, () => [
                      vue.createVNode("span", null, vue.toDisplayString(_ctx.content), 1 /* TEXT */)
                    ])
                  ]))
    ...
    ((_ctx.showText || _ctx.$slots.default) && !_ctx.textInside)
      ? (vue.openBlock(), vue.createBlock("div", {
          ...
          vue.renderSlot(_ctx.$slots, "default", _ctx.slotData, () => [
            (!_ctx.status)
              ? (vue.openBlock(), vue.createBlock("span", _hoisted_4, vue.toDisplayString(_ctx.content), 1 /* TEXT */))
