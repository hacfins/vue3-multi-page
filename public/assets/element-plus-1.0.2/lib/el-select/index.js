...
var script$2 = vue.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const { inputWidth, selected, inputLength, filteredOptionsCount, visible, softFocus, selectedLabel, hoverIndex, query, inputHovering, currentPlaceholder, menuVisibleOnFocus, isOnComposition, isSilentBlur, options, cachedOptions, optionsCount, prefixWidth, tagInMultiLine, } = vue.toRefs(states);
            ...
            (_ctx.emptyText && (!_ctx.allowCreate || _ctx.loading || (_ctx.allowCreate && _ctx.options.size === 0 )))
              ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
                  (_ctx.$slots.empty)
                    ...
                    : (vue.openBlock(), vue.createBlock("p", _hoisted_5, vue.toDisplayString(_ctx.emptyText), 1 /* TEXT */))
