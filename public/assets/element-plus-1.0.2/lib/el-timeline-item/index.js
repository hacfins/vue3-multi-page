...
const _hoisted_2 = /*#__PURE__*/vue.createVNode("div", { class: "el-timeline-item__tail" }, null, -1 /* HOISTED */);
const _hoisted_3 = {
  key: 1,
  ...
  return (vue.openBlock(), vue.createBlock("li", _hoisted_1, [
    ...
    vue.createVNode("div", _hoisted_4, [
      (!_ctx.hideTimestamp && _ctx.placement === 'top')
        ? (vue.openBlock(), vue.createBlock("div", _hoisted_5, vue.toDisplayString(_ctx.timestamp), 1 /* TEXT */))
        : vue.createCommentVNode("v-if", true),
      vue.createVNode("div", _hoisted_6, [
        vue.renderSlot(_ctx.$slots, "default")
      ]),
      (!_ctx.hideTimestamp && _ctx.placement === 'bottom')
        ? (vue.openBlock(), vue.createBlock("div", _hoisted_7, vue.toDisplayString(_ctx.timestamp), 1 /* TEXT */))
        : vue.createCommentVNode("v-if", true)
    ])
  ]))
}
